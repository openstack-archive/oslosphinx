...
class BlueprintChecker(object):
    ...
    def _load_project_settings(self):
        ...
        if project_name:
            ...
            project_group = self.lp.project_groups[pg_name]
            projects = project_group.projects
            self.project_names = [p.name for p in projects]
            self._warn_search = 'any projects in the %s project group' % pg_name
    ...
    def check(self, bp_name):
        ...
        for project_name in self.project_names:
            ...
            raise ValueError('Document %s does not match any blueprint name in %s'
                             % (bp_name, self._warn_search))
