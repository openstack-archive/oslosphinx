...
class SupportMatrixTarget(object):
    ...
    def __init__(self, key, title, driver, plugin=None, architecture=None):
        """Targets are the plugins we are comparing feature against
...
class SupportMatrixDirective(rst.Directive):
    ...
    def _load_support_matrix(self):
        """Read support-matrix.ini file and populates data """
    ...
    def _build_summary(self, matrix, content):
        """Constructs content for the summary of the support matrix.
    ...
    def _build_details(self, matrix, content):
        """Constructs content for the details of the support matrix."""
...
def setup(app):
    ...
    app.add_stylesheet('theme/openstack/static/support_matrix.css')
